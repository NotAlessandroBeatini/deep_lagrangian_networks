...
def activation_matrix_fn(q, n_dof, shape, activation, epsilon, shift):
    assert n_dof > 0
    ...
    activation_mat = jnp.matmul(triangular_mat, triangular_mat.transpose())
